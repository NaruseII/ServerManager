...
public class BungeeManagerPlugin extends Plugin {
    ...
    public void onEnable() {
        ...
        this.serverManager = new ServerManager(new CoreData(CoreServerType.BUNGEE_MANAGER, this.getDataFolder(), 4848, "bungee-manager", 0));
